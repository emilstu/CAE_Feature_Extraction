...
class CAE_2D:
    def __init__(self, model_name, patch_size, patch_overlap, min_labeled_pixels, test_size, load_model_for_pred, img_dir, seg_dir, out_dir, model_dir=None):
        """
    ...
    def load_patch_list_from_disk(self):
        self.patch_train_list = util.load_sample_list('train_samples', self.model_dir)
        self.patch_test_list= util.load_sample_list('test_samples', self.model_dir)
